...
if ($objYTube->BigVideo && empty($_GET['showOnly'])) {
    ...
    <div class="clear clearfix">
        <div class="row thumbsImage">
            <div class="col-sm-6">
                <a class="YouTubeLink" videos_id="<?php echo $video['id']; ?>" href="<?php echo Video::getLink($video['id'], $video['clean_title'], false, $get); ?>" title="<?php echo $video['title']; ?>" style="">
                    <?php
                    ...
                    <div class="aspectRatio16_9">
                        ...
                        <?php if (!empty($imgGif)) { ?>
                            <img src="<?php echo getCDN(); ?>view/img/loading-gif.png" data-src="<?php echo $imgGif; ?>" style="position: absolute; top: 0; display: none;" alt="<?php echo $video['title']; ?>" id="thumbsGIF<?php echo $video['id']; ?>" class="thumbsGIF img-responsive <?php echo @$img_portrait; ?>  rotate<?php echo $video['rotation']; ?>" height="130" />
                        <?php } ?>
                    </div>
                    <?php
            ...
            <div class="col-sm-6">
                <a class="h6 YouTubeLink" videos_id="<?php echo $video['id']; ?>" href="<?php echo Video::getLink($video['id'], $video['clean_title'], false, $get); ?>" title="<?php echo $video['title']; ?>">
